    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        ...
        li{float: left;padding: 2px 5px ;border: 1px solid #dadada;margin: 2px 2px;}
        ...
        <div style="display: block;margin-top: 10px;background: #fff;border: 1px solid #f1f1f1;float: left;width: 95%">
        ...
        <li><a href="/plus/view.php?aid=23">美国本土免费礼物Amazon群</a></li>
        </ul>
        </div>
        <div style="display: block;margin-top: 10px;background: #fff;border: 1px solid #f1f1f1;float: left;width: 95%">
        <h4 style="float: left;">温州跨境电商交流集群</h4>
        ...
        <div style="margin: 10px 0px 30px;float: left; margin-bottom: 80px;">
        <h4>已入群群员(2000)</h4>
        <div class="weui-flex">
