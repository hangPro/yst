...
public class CodeGeneratorConfig {
	...
	// 项目在硬盘上的基础路径
	protected static final String PROJECT_PATH = System.getProperty("user.dir").replace("\\","/");
	// java文件路径
	protected static String JAVA_PATH;
	// java文件路径
	protected static String JAVA_PATH_COMMON;
	// java文件路径
	protected static String JAVA_PATH_WEB;
	// 资源文件路径
